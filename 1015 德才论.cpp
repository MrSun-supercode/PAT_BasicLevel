...
//	{
//		if (origin[i].grade_cai>h&&origin[i].grade_de>h)
//		{
...
//		if (origin[i].grade_cai <=h&&origin[i].grade_de > h)
//		{
//			Second.push_back(origin[i]);
//		}
//	}
//	for (int i = 0; i < origin.size(); i++)
//	{
//		if (origin[i].grade_cai < h&&origin[i].grade_de > h&&origin[i].grade_de>=origin[i].grade_cai)
//		{
//			Third.push_back(origin[i]);
//		}
//	}
//
//
